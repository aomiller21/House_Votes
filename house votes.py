        ...
        while True:
            ...
            for vote in vote_containers:
                try:
                    ...
                    # Apply manual overrides for specific roll call numbers
                    if roll_call_number == "1":
                        combined_description = "Call by States: Quorum"
                    elif roll_call_number == "2":
                        tally = "218-215"
                        status = "Speaker Mike Johnson"
                        combined_description = "Election of the Speaker"
